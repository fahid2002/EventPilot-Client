    ...
    <section className="mx-auto grid min-h-[calc(100vh-5rem)] max-w-7xl items-center gap-10 px-4 py-12 sm:px-6 lg:grid-cols-2 lg:px-8">
      <div>
        ...
        <p className="mt-4 max-w-xl leading-8 text-slate-600 dark:text-slate-300">
          Login with email/password or Google. After login, the navbar shows your profile photo, role, and membership. Demo users can view the platform but cannot perform protected actions.
        </p>
