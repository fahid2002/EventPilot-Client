...
// Number of events shown on each page
const perPage = 8;

export default function ExplorePage() {
  // Event data and loading state
  ...
  useEffect(() => {
    ...
    // Loads approved events from the backend
  ...
  // Filters and sorts the event list
  ...
  // Calculates total pages and events for the current page
    ...
    <>
      ...
      <section className="bg-white py-10 dark:bg-slate-900/40">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="mt-2 text-4xl font-black tracking-tight">
            Find your next tech event
          </h1>

          <p className="mt-4 max-w-2xl text-slate-600 dark:text-slate-300">
            Search by title, filter by category, location, and free/premium
            access, then sort results before attending.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        ...
        <div className="rounded-[2rem] border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900">
          <div className="grid gap-4 lg:grid-cols-6">
            <input
              ...
              className="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 outline-none focus:border-brand-500 dark:border-slate-800 dark:bg-slate-950 lg:col-span-2"
        ...
        {loading ? (
          ...
          /* Empty state when no events match the filters */
          <div className="mt-8 rounded-[2rem] border border-dashed border-slate-300 bg-white p-10 text-center dark:border-slate-700 dark:bg-slate-900">
            ...
            <p className="mt-2 text-slate-600 dark:text-slate-300">
              Try changing your keyword, category, location, or access type.
            </p>
          </div>
        )}
        ...
        <div className="mt-10 flex items-center justify-center gap-2">
          <button
            ...
            className="rounded-xl border border-slate-200 px-4 py-2 font-black disabled:opacity-40 dark:border-slate-800"
          >
            Previous
          </button>
